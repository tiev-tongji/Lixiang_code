...
cam_r = np.load("/..../R.npy", allow_pickle=True)
cam_t = np.load("/..../T.npy", allow_pickle=True)

lid_r = np.load("/....lidar_R.npy", allow_pickle=True)
lid_t = np.load("/....lidar_T.npy", allow_pickle=True)


print('相机R:',cam_r[0,:].shape)
print('相机T:',cam_t[0,:].shape)
print('雷达R:',lid_r[0,:].shape)
print('雷达T:',lid_t[0,:].shape)
...
np.save("/..../lidar/T.npy", Sum_T)
np.save("/..../lidar/R.npy", Sum_R)