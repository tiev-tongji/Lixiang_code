...
from DDR import Bottleneck3D_Down, Bottleneck3D
...
class SegmentationHead(nn.Module):
    ...
    def __init__(self, inplanes, planes, nbr_classes, dilations_conv_list):
        ...
        # First convolution
        self.conv0 = nn.Conv3d(inplanes, planes, kernel_size=(3,3,3), padding=1, stride=(1,1,1))
        ...
        self.conv1 = nn.ModuleList(
            [
                nn.Conv3d(
                    planes, planes, kernel_size=(3,3,3), padding=dil, dilation=dil, bias=False
                )
        ...
        self.conv_classes = nn.Conv3d(
            planes, nbr_classes, kernel_size=(3,3,3), padding=1, stride=(1,1,1)
        )
...
class Process(nn.Module):
    def __init__(self, feature, norm_layer, bn_momentum, dilations):
